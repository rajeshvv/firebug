...
// this objects define explicitely what functions or properties to include in FBL, 
...
{
    FBTrace.sysout("An error has occured. Are there collisions in FBLExtension?");
    throw ex;
}
